...
class InvitationRepository extends Repository
{
    ...
    public function findByStatusAndCategories(int $status, array $categories) : QueryResultInterface
    {
        $query = $this->createQuery();
        $query->matching(
            $query->logicalAnd(
    ...
    public function findPendingUnsentInvitations() : QueryResultInterface
    {
        $query = $this->createQuery();
